    ...
    <section className="after-hero relative min-h-[70vh] bg-[#FFF5F0] text-gray-900">
      <div className="mx-auto flex min-h-[60vh] max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="relative isolate mx-auto flex w-full items-center justify-between gap-6 px-0 sm:gap-10">
          {/* Imagen izquierda flotante (siempre visible) */}
          ...
          <div className="relative mx-auto text-center">
            <h2 className="mx-auto max-w-5xl text-pretty text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
              OFRECEMOS PRODUCTOS DE CALIDAD, EN <span className="relative inline-block">
                <span className="relative z-10" style={{ color: GOLD_COLOR }}>BENITO</span>
              </span> CONOCERÁS <span className="relative inline-block" style={{ color: GOLD_COLOR }}>EL SABOR</span> DE NUESTRA CARNE.
            </h2>
          </div>

          {/* Imagen derecha flotante (siempre visible) */}
...
// Componente auxiliar: retrato con animación de flotación
